...
class SmsController {
  ...
  static sendSms(req, res) {
    ...
    Contact.findOne({ phoneNumber: reciever })
      ...
      .then((recieverContact) => {
        ...
        let sms1 = new Sms({
          sender, reciever, text, contact: recieverContact._id, status: 'sent'
        })
        let sms2 = new Sms({
          sender, reciever, text, contact: recieverContact._id, status: 'received'
        })
        sms2.save()
        return sms1
          .save()
